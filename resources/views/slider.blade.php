    ...
    <script>
        new Swiper('#swiper-{{ $id }}', {
            ...
            @else
                breakpoints: {
                    375: {
                        slidesPerGroup: {{ $columns - 3 > 0 ? $columns - 3 : 1 }},
                        slidesPerView: {{ $columns - 3 > 0 ? $columns - 3 : 1 }},
                    },
                    640: {
                        slidesPerGroup: {{ $columns - 2 > 0 ? $columns - 2 : 2 }},
                        slidesPerView: {{ $columns - 2 > 0 ? $columns - 2 : 2 }}
                    },
                    1024: {
                        slidesPerGroup: {{ $columns - 1 > 0 ? $columns - 1 : 3 }},
                        slidesPerView: {{ $columns - 1 > 0 ? $columns - 1 : 3 }}
                    },
                    1280: {
