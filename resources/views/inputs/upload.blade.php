    ...
    <div class="flex flex-1 mt-2">
        <div class="flex-1 h-full sm:grid sm:grid-cols-2 sm:gap-4 sm:items-start">
            <div class="h-full sm:col-span-2">
                <div class="flex justify-center h-full px-6 pt-5 pb-6 border-2 border-dashed rounded-md border-theme-secondary-300">
                    <div class="m-auto text-center">
                        <svg class="w-12 h-12 mx-auto text-theme-secondary-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
