<div x-data="{ open: false }" @keydown.window.escape="open = false" @click.away="open = false" class="relative inline-block w-full text-left">
    <div>
        <button
            @click="open = !open"
            type="button"
            class="inline-flex items-center justify-start w-full px-4 py-3 border rounded-lg border-theme-secondary-200"
        >
    ...
    <div
        ...
        class="absolute right-0 z-10 w-full mt-2 origin-top rounded-md shadow-lg"
        x-cloak
    >
